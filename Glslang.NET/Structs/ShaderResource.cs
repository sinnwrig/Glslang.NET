...
public struct ShaderResource 
{
    ...
    private static extern IntPtr GetDefaultResource();
    public static readonly ShaderResource DefaultResource = Marshal.PtrToStructure<ShaderResource>(GetDefaultResource());
}